...
### Hau Nguyen
- Clone app from https://github.com/Urigo/angular2-meteor-base
- Update to Meteor 1.5.1 by meteor update
- Open command prompt at app folder
- Run command: SET AOT=1
- Run command: npm start
- Open chrome and go to http://localhost:3000/
- Open the developer tools, I still can find ngfactory files.